...
// Expanded to reduce collisions across many korda names.
export const KORDA_COLORS = [
  // Solid variants
  { bg: "bg-red-50", headerBg: "bg-red-500", border: "border-red-500", text: "text-red-800" },
  { bg: "bg-orange-50", headerBg: "bg-orange-500", border: "border-orange-500", text: "text-orange-800" },
  { bg: "bg-amber-50", headerBg: "bg-amber-500", border: "border-amber-500", text: "text-amber-800" },
  { bg: "bg-yellow-50", headerBg: "bg-yellow-500", border: "border-yellow-500", text: "text-yellow-800" },
  { bg: "bg-lime-50", headerBg: "bg-lime-500", border: "border-lime-500", text: "text-lime-800" },
  { bg: "bg-green-50", headerBg: "bg-green-500", border: "border-green-500", text: "text-green-800" },
  { bg: "bg-emerald-50", headerBg: "bg-emerald-500", border: "border-emerald-500", text: "text-emerald-800" },
  { bg: "bg-teal-50", headerBg: "bg-teal-500", border: "border-teal-500", text: "text-teal-800" },
  { bg: "bg-cyan-50", headerBg: "bg-cyan-500", border: "border-cyan-500", text: "text-cyan-800" },
  { bg: "bg-sky-50", headerBg: "bg-sky-500", border: "border-sky-500", text: "text-sky-800" },
  { bg: "bg-blue-50", headerBg: "bg-blue-500", border: "border-blue-500", text: "text-blue-800" },
  { bg: "bg-indigo-50", headerBg: "bg-indigo-500", border: "border-indigo-500", text: "text-indigo-800" },
  { bg: "bg-violet-50", headerBg: "bg-violet-500", border: "border-violet-500", text: "text-violet-800" },
  { bg: "bg-purple-50", headerBg: "bg-purple-500", border: "border-purple-500", text: "text-purple-800" },
  { bg: "bg-fuchsia-50", headerBg: "bg-fuchsia-500", border: "border-fuchsia-500", text: "text-fuchsia-800" },
  { bg: "bg-pink-50", headerBg: "bg-pink-500", border: "border-pink-500", text: "text-pink-800" },
  { bg: "bg-rose-50", headerBg: "bg-rose-500", border: "border-rose-500", text: "text-rose-800" },
  { bg: "bg-slate-50", headerBg: "bg-slate-500", border: "border-slate-500", text: "text-slate-800" },
  ...
  },
  {
    ...
    headerBg: "bg-gradient-to-r from-yellow-500 to-lime-500",
  ...
  },
  {
    ...
    headerBg: "bg-gradient-to-r from-rose-500 to-red-500",
    border: "border-rose-400",
    text: "text-rose-900",
  },
  {
    bg: "bg-gradient-to-br from-red-50 to-violet-50",
    headerBg: "bg-gradient-to-r from-red-500 to-violet-500",
    border: "border-red-400",
    text: "text-red-900",
  },
  {
  ...
  },
  {
    ...
    headerBg: "bg-gradient-to-r from-amber-500 to-emerald-500",
    border: "border-amber-400",
    text: "text-amber-900",
  },
  {
    bg: "bg-gradient-to-br from-lime-50 to-teal-50",
    headerBg: "bg-gradient-to-r from-lime-500 to-teal-500",
    border: "border-lime-400",
    text: "text-lime-900",
  },
  {
    bg: "bg-gradient-to-br from-green-50 to-cyan-50",
    headerBg: "bg-gradient-to-r from-green-500 to-cyan-500",
    border: "border-green-400",
    text: "text-green-900",
  },
  {
    bg: "bg-gradient-to-br from-sky-50 to-indigo-50",
    headerBg: "bg-gradient-to-r from-sky-500 to-indigo-500",
    border: "border-sky-400",
    text: "text-sky-900",
  },
  {
    bg: "bg-gradient-to-br from-slate-50 to-blue-50",
    headerBg: "bg-gradient-to-r from-slate-500 to-blue-500",
    border: "border-slate-400",
    text: "text-slate-900",
  },
  {
    bg: "bg-gradient-to-br from-slate-50 to-purple-50",
    headerBg: "bg-gradient-to-r from-slate-500 to-purple-500",
    border: "border-slate-400",
    text: "text-slate-900",
  },
];
